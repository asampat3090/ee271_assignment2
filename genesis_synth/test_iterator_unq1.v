...
<<<<<<< HEAD:rtl/test_iterator.vp~
	...
	( TEST_STATE ): begin
	  // set to the next sample to test
	   ...
	   begin
		...
		if(validPoly_R13H == 1'b1) //another poly is immediately available
		begin
			//initialize values
			next_sample_R14S[0] = box_R13S[0][0];
			next_sample_R14S[1] = box_R13S[0][1];
   ...
   //; }
=======
>>>>>>> aa205e8e54f30605c4d71d1a2367f4dd56976d22:genesis_synth/test_iterator_unq1.v
